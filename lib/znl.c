...
#define ZNL_NLMSG_DATA(nlh)	((void*)((char*)(nlh)+sizeof(struct nlmsghdr)))
#define ZNL_NLMSG_DATALEN(nlh)	((nlh)->nlmsg_len-sizeof(struct nlmsghdr))
#define ZNL_NLMSG_DATAEND(nlh)	((char*)(nlh)+(nlh)->nlmsg_len)
#define ZNL_NLMSG_NEXT(nlh)	(struct nlmsghdr*)((char*)(nlh)+ZNL_ALIGN((nlh)->nlmsg_len))
#define ZNL_NLMSG_OK(nlh,end)	((char*)(end)-(char*)(nlh) >= sizeof(struct nlmsghdr))

#define ZNL_RTA_DATAEND(rta)	((char*)(rta)+(rta)->rta_len)
#define ZNL_RTA_NEXT(rta)	(struct rtattr*)((char*)(rta)+ZNL_ALIGN((rta)->rta_len))
#define ZNL_RTA_OK(nlh,end)	((char*)(end)-(char*)(rta) >= sizeof(struct rtattr))

#define ZNL_NLMSG_RTA(nlh,len)	((void*)((char*)(nlh)+sizeof(struct nlmsghdr)+ZNL_ALIGN(len)))
#define ZNL_NLMSG_RTAOK(rta,nlh) ZNL_RTA_OK(rta,NLMSG_DATAEND(nlh))
...
struct rtattr *znl_rta_pull(struct zbuf *zb, struct zbuf *payload)
{
	...
	zbuf_init(payload, znl_pull(zb, plen), plen, plen);
	//zbuf_pulln(zb, ZNL_ALIGN(plen) - plen);
